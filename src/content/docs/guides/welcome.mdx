...
3. Select the starter you want

</Steps>

# Linking other account

Once you have started on either Discord or Telegram, you can link your account with the other platform so that you can play on both. To do so, run [/settings link](/commands/settings/link) and follow the instructions.
...
To get familiar with the bot's system, we recommend reading the following pages:

<LinkCard title="Obtaining Pokémon" href="/guides/obtaining_pokemon"></LinkCard>


<LinkCard title="Obtaining Pokémon" href="/guides/levelling"></LinkCard>

{/* TODO viewing stats (iv vs ev, how to increase ev) */}


<LinkCard title="Duelling" href="/guides/duelling"></LinkCard>

{/* TODO Buying/Selling Pokemon: page that explains market and auction togteher */}

{/* TODO shop system (no inventory, everything gets applied to your selected pokemon, what does xp booster/blocker do, what do stones do, what does rare candy do etc) */}